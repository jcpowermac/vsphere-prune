module github.com/jcpowermac/vsphere-prune

go 1.26.4

require (
	github.com/openshift/ci-tools v0.0.0-00010101000000-000000000000
...
replace github.com/openshift/ci-tools => ../ci-tools
